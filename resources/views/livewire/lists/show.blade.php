            ...
            <div class="p-5 space-y-5">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="p-3 rounded-lg bg-black/[0.02] dark:bg-white/[0.03]">
                            <div class="flex items-center justify-between">
                                <span class="text-xs text-gray-400">Mit Beispielsatz</span>
                ...
                <div>
                    <h3 class="text-xs font-medium uppercase tracking-wider text-gray-400 mb-3">Wortarten</h3>
                ...
                {{-- Quick Actions --}}
                <div>
                    <h3 class="text-xs font-medium uppercase tracking-wider text-gray-400 mb-3">Schnellzugriff</h3>
                    <div class="space-y-2">
